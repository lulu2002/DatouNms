...
public class CraftCommonNMS extends CommonNMS {
    ...
    protected String getBreakSoundString(Material material) {
        ...
        net.minecraft.server.v1_9_R2.Block nmsBlock = net.minecraft.server.v1_9_R2.Block.REGISTRY.get(materialKey).getBlockData().getBlock();
    ...
    public Entity getEntity(UUID uuid) {
        net.minecraft.server.v1_9_R2.Entity entity = (( CraftServer ) Bukkit.getServer()).getServer().a(uuid);
