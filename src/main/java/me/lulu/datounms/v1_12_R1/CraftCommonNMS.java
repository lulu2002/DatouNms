package me.lulu.datounms.v1_12_R1;
...
public class CraftCommonNMS extends CommonNMS {
    ...
    public String getMinecraftSoundKey(SentPacket packet) {
        return SoundEffect.a.b((SoundEffect) packet.getPacketValue(0)).toString();
    }
    ...
    protected String getBreakSoundString(Material material) {
        ...
        net.minecraft.server.v1_12_R1.Block nmsBlock = net.minecraft.server.v1_12_R1.Block.REGISTRY.get(materialKey).getBlockData().getBlock();
    ...
    public Entity getEntity(UUID uuid) {
        net.minecraft.server.v1_12_R1.Entity entity = ((CraftServer) Bukkit.getServer()).getServer().a(uuid);
    ...
    public void setCanPickupExp(Player p, boolean b) {
        ...
        entityPlayer.bD = b ? 0 : Integer.MAX_VALUE;
    }
}