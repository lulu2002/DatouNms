...
public class CraftCommonNMS extends CommonNMS {
    ...
    protected String getBreakSoundString(Material material) {
        ...
        net.minecraft.server.v1_10_R1.Block nmsBlock = net.minecraft.server.v1_10_R1.Block.REGISTRY.get(materialKey).getBlockData().getBlock();
    ...
    public Entity getEntity(UUID uuid) {
        net.minecraft.server.v1_10_R1.Entity entity = (( CraftServer ) Bukkit.getServer()).getServer().a(uuid);
    ...
    public void setCanPickupExp(Player p, boolean b) {
        ...
        entityPlayer.bA = b ? 0 : Integer.MAX_VALUE;
    }
